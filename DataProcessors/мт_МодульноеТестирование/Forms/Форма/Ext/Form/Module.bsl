...
// Запуск тестов выполняется по одному через обработчик ожидания в 0.1 с между шагами для обновления сведений о текущем
// результате. Поэтому алгоритм перебора тестов получился сложноватым, но мы имеем возможность наблюдать за состоянием
// во время выполнения.
